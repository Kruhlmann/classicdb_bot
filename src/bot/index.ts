import { Client as DiscordAPIClient, Message as DiscordMessage } from "discord.js";
import { BotAlreadyStartedError } from "../exceptions";
import { Message } from "./message";

export const DISCORD_READY_EVENT_NAME = "ready";
export const DISCORD_MESSAGE_EVENT_NAME = "message";
...
export class ClassicDBBot {
    ...
    private process_discord_channel_message_if_relevant(message: Message): void {
    ...
    private register_message_event_handler(): void {
        this.discord_api_client.on(DISCORD_MESSAGE_EVENT_NAME, (message?: DiscordMessage) => {
            const converted_message = Message.from_discord_api_message(message, this.discord_api_client);
            this.process_discord_channel_message_if_relevant(converted_message);
        });
    }
