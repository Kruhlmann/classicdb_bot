...
export class EmbedBuilder {
    ...
    public set_inventory_class(inventory_type: { name: string } | undefined, subclass: { name: string } | undefined, is_subclass_hidden: boolean | undefined): this {
    ...
    public set_weapon(weapon: { damage: { display_string: string }, attack_speed: { display_string: string }, dps: { display_string: string } } | undefined): this {
        if (weapon !== undefined) {
            this.description.push(`**${weapon.damage.display_string}**`);
            this.description.push(`**${weapon.attack_speed.display_string}**`);
            this.description.push(`**${weapon.dps.display_string}**`);
        }
        return this;
    }
    ...
    public set_itemset(set: { items: Array<{ item: { name: string, id: number }}>, effects: Array<{ display_string: string }>, display_string: string } | undefined): this {
        if (set !== undefined) {
            this.description.push("")
